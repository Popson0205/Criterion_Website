...
<nav class="navbar">
  <div class="navbar-inner">
    <a href="/" class="navbar-brand">
      ...
      <div class="navbar-name">Criterion College<span>Excellence · Integrity · Service</span></div>
    </a>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
          ...
          <span style="color:var(--white);font-weight:700;font-size:1.05rem">Criterion College</span>
        </div>
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="mailto:info@criterioncollege.edu.ng">info@criterioncollege.edu.ng</a></li>
          <li><a href="/pages/contact.html">Find Us</a></li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <span>&copy; ${new Date().getFullYear()} Criterion College. All rights reserved.</span>
